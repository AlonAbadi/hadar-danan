 ...
 *
 * Style note: Hebrew copy in this project uses periods and commas only —
 * never em dashes. The verses below were normalized accordingly.
 */
...
const VERSES: TaoVerse[] = [
  ...
  { chapter: 48, he: "הלימוד הוא להוסיף יום יום. הדרך היא לגרוע יום יום." },
