...
export const PRODUCT_META: Record<string, string> = {
  ...
  signal_hive:   "ערכת הפעלה · גישה מיידית",
...
export const PRODUCT_DESC: Record<string, string> = {
  ...
  signal_hive:   "האות שלך ארוז לפעולה - אתגר, תוכן, ויזואל ובימוי, הכל מהאות שלך",
  strategy:      "שעה אחת עם הדר שתבהיר יותר מחודשים של ניסיון עצמאי",
  premium:       "יום שלם עם הצוות - ותצא עם 14 סרטונים מוכנים לפרסום",
...
export const BULLET_RULES: Record<string, BulletRule[]> = {
  ...
  signal_hive: [
    { q: 3, a: "B", text: "אתה לומד בקצב שלך - הכל פתוח לך במקום אחד, מתי שנוח" },
    { q: 0, a: "C", text: "עסק מבוסס שרוצה לשדר את עצמו - כוורת האות נותנת את הכלים" },
    { q: 1, a: "B", text: "יש תוכן בלי תוצאות - כוורת האות מחברת הכל לאות שלך" },
    { q: 2, a: "C", text: "מייצר תוכן אבל לא מרוצה מהאיכות - כאן הכל נגזר מהאות שלך" },
    { q: 2, a: "B", text: "לא עקבי - 7 ימים ממוסגרים סביב האות בונים לך מסגרת" },
  ],
  strategy: [
  ...
  premium: [
    ...
    { q: 2, a: "D", text: "רוצה תוכן ברמה מקצועית גבוהה - 14 סרטונים שמדברים בעד עצמם" },
...
export function getPersonalizedReasons(answers: Answer[], productId: string): string[] {
  ...
  const fallbacks: Record<string, string[]> = {
    ...
    signal_hive:   ["האות שלך, ארוז לפעולה", "אתגר, תוכן, ויזואל ובימוי - הכל מהאות שלך", "הצעד שמתחיל להוציא את האות לעולם"],
    strategy:      ["מפה מפורטת לצמיחה מותאמת לעסק שלך", "תשובות שרק מי שעשה את זה יכול לתת", "פגישה אחד על אחד עם הדר"],
    premium:       ["14 סרטונים מקצועיים ביום אחד", "הצוות שלנו עושה את כל העבודה", "תוכן שמשדר את הרמה האמיתית שלך"],
