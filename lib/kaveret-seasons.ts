...
export const KAVERET_SEASONS: KaveretSeason[] = [
  ...
  },
  {
    ...
    why:      "הזהות של אלה שעוברים אחריכם נוצרת מתוך הסיפור שלכם. בלי הסיפור, האות נשמעת כמו נוסחה.",
  },
  {
    number:   8,
    title:    "המנטרות",
    ...
    why:      "המותג שלכם נשאר בזיכרון של הקהל בזכות המנטרות. הן הרגע שבו האות הופכת למשהו שאפשר להחזיק.",
  },
  {
    number:   9,
  ...
  },
  {
    ...
    why:      "האות הופכת לחיה ולא לספר. הקהל רואה שאתם מדברים עכשיו, לא בשנה שעברה.",
  },
];
