...
const EMOTIONAL_ANCHOR: Record<Stage, string> = {
  ...
  established:
    "תקרה היא לא כשלון. היא סימן שהתחלתם להבין את העסק שלכם ברמה שלא ידעתם קודם. הצעד הבא הוא לא עוד פעולה - הוא רמת מודעות חדשה. רוב מי שמגיע לכאן לא חוזר לאחור.",
  company_brand:
