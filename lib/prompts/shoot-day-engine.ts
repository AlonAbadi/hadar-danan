...
const HADAR_SIGNATURE_MOVES = `12 המהלכים של הדר (8 גרעיניים + 4 חדשים מהקורפוס המורחב 2026-06-16: Toko Aroma, Hila Uri Lev). כל סרטון חייב להפעיל לפחות אחד:
...
7. Embodiment direction (Projective). הוראות גוף לסמכות. "לא לזוז בכיסא. בלי לכרסם ציפורניים. אתה יודע שאתה עושה את זה כמו שצריך." מתאים למותגים קוגניטיביים-עסקיים (יועץ, מאמן, אסטרטג, מנטור).
...
11. Receptive Embodiment (חדש — Toko Aroma). הוראת גוף הפוכה ממהלך #7, למותגים חושיים. לא להציג, לקבל. לאט. נוכח. ממתין. ציטוט הדר על סט: "לאט, כל פעולה לאט. סתכל, זה הריח. תפתח. תהיה בנחה. עושה ככה, מריח, חכה ותהיה איתי. אל תהיה דם." כל סרטון של מותג חושי חייב Receptive Embodiment, לא Projective.
...
עקרון על: 8 המהלכים הראשונים יציבים בכל תחום. 4 האחרונים נבחרים לפי ארכיטיפ המותג:
- מותג קוגניטיבי-עסקי (יועץ, מאמן, אסטרטג, מנטור): השתמש ב-1-8. מהלך #7 (Projective Embodiment).
- מותג חושי (ריח, אוכל, יין, ספא, אומנות): השתמש ב-1-6, 8, ו-9-11 (Receptive Embodiment, לא Projective).
...
המנטרה הקנונית של 2026-06-16 (Toko Aroma, C4367): "הכול חייב לנגן." כל פלט חייב להישמע כמו שהוא מנגן, לא כמו שהוא מסביר.`;
...
מבנה חובה: "כש[מצב חיצוני שאחרים נמנעים ממנו], אני [פעולה ספציפית של התחלה]." (פסיק. לא מקף ארוך.)
