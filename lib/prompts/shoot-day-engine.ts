...
4. **signature_move**:
   ...
   - **הרשימה הסגורה של 17 השמות** (העתק מדויק, כולל אנגלית):
     "External→Internal Translation" · "Service Reframe" · "אני אקביל לך Parable Building" · "Tangible Metaphor Anchor" · "Sold-Inversion" · "Self-as-example" · "Embodiment direction (Projective)" · "Anti-flattery" · "Sensory-to-Business Translation" · "Process-as-Proof" · "Receptive Embodiment" · "Specificity-as-Service" · "Silent Authority Positioning" · "Category-Rename / Reclaim" · "Diagnostic-Framework Reveal" · "Moral-Obligation Activation" · "Chain-Collapse Rhetoric"
