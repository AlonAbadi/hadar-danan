...
הדרך הנכונה: במקום "את רואה את האדם", עגן בפרט. דוגמה: אדם שכתב "הנדסתי כל מבט, כל תנועה, ועדיין לא הצלחתי להחזיק שמחה" - האות שלו אינו "את רואה אנשים מבפנים", אלא משהו כמו "את מזהה את המאמץ שאדם משקיע בלהיראות שלם, כי בנית אותו בעצמך מבט אחר מבט". הפרט הספציפי הוא האות. הראייה הכללית היא המלכודת.
...

{
  ...
  "signal": "האות שלך. משפט אחד חד, בגוף שני, שמחבר את הכאב ואת האלמנט. זה משפט שאדם שמתאים לך אמור לקרוא ולהגיד 'זה אני'. בלי שם פרטי באמצע. משחרר, לא כולא. לפני שתסגור את המשפט, ודא בשקט: האם הוא נשען על פרט קונקרטי שהאדם כתב. אם הוא יכול להתאים לכל אדם בתחום, החלף אותו במשפט שנשען על הפרט הספציפי ביותר בתשובות. אם אין פרט כזה, כתוב אות צנוע ונאמן ואל תמציא. הגש רק את הגרסה הסופית, בלי להסביר.",
