...
- recommended_bucket (חובה, אחד מארבעה ערכים בלבד):
  * "strategy" - אחד מבין השניים: (א) זוהו רמזי בעל עסק פעיל בתשובות (מדבר/ת על לקוחות שלי, העסק שלי, הצוות, המנויים, ניהול/הקמת עסק/סוכנות) + סימן מחויבות פעולה ספציפית (החלטה, אופק זמן, "השנה", "ברבעון", "מתחייב", "מקדישה"). (ב) תחום העיסוק מצביע על מקצוע מבוסס וגבוה-ערך (עו"ד / רופא/ה / פסיכולוג/ית / רואה חשבון / נדל"ן / אדריכל/ית / יועץ/ת בכיר/ה / מטפל/ת ותיק/ה / מאמן/ת עסקית מבוססת) **וגם** התשובות עמוקות, ארוכות ומבטאות בגרות וניסיון חיים. במקרה הזה אדם הוא מועמד טבעי לפגישת אסטרטגיה גם אם שאלות הנפש לא העלו ממנו מילים מסחריות מובהקות — קיים אצלו פוטנציאל הכנסה גבוה ויש לו מה לתרגם למיתוג.
