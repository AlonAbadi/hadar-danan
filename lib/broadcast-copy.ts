...
export const BROADCAST_COPY = {
  ...
  // Native-capture guided wizard (r4, expert-panel respec)
  "native.intro_title": "מצלמים אותך, בשלושה צעדים",
  "native.intro_step1": "הטקסט שלך יופיע בחלון קטן שצף על המסך",
  "native.intro_step2": "המצלמה הרגילה של הטלפון תיפתח, והחלון יישאר מעליה",
  "native.intro_step3": "לוחצים על הכפתור האדום, לוחצים נגן בחלון הטקסט, ומדברים",
  "native.intro_reassure": "אפשר לצלם כמה פעמים שרוצים. אף אחד לא רואה את הניסיונות.",
  "native.intro_cta": "הבנתי, בואו נתחיל",
  "native.step1_label": "שלב 1 מתוך 2",
  "native.step2_label": "שלב 2 מתוך 2",
  "native.s1_title": "קודם כול, נרים את הטקסט לאוויר",
  "native.s1_explain": "בלחיצה, הטקסט שלך יעבור לחלון קטן שצף מעל הכול. הוא יחכה שם בלי לזוז עד שנגיע למצלמה.",
  "native.s1_cta": "הצגת הטקסט בחלון הצף",
  "native.s1_success": "החלון באוויר",
  "native.s1_drag": "אפשר לגרור אותו לכל מקום על המסך, וצביטה מגדילה אותו",
  "native.s2_title": "עוד רגע מצלמים. שלושה דברים בפנים:",
  "native.s2_item1": "לוחצים על הכפתור האדום של המצלמה, כמו בכל סלפי",
  "native.s2_item2": {
    f: "לוחצים נגן בחלון הטקסט ברגע שאת מתחילה לדבר",
    m: "לוחצים נגן בחלון הטקסט ברגע שאתה מתחיל לדבר",
  },
  "native.s2_item3": "בסוף עוצרים ולוחצים \"השתמש בסרטון\". משם הכול חוזר אלינו לבד",
  "native.s2_pacing_title": "איך הטקסט זז?",
  "native.s2_pacing_body": {
    f: "בקצב קבוע ונעים, כמו טלפרומפטר באולפן טלוויזיה. הוא לא מחכה לך, ואת לא צריכה לרדוף אחריו. נגיעה בחלון מציגה כפתורים: עצירה, המשך, וחזרה 15 שניות אחורה. פספסת שורה? עצרי, חזרי אחורה, והמשיכי כאילו כלום.",
    m: "בקצב קבוע ונעים, כמו טלפרומפטר באולפן טלוויזיה. הוא לא מחכה לך, ואתה לא צריך לרדוף אחריו. נגיעה בחלון מציגה כפתורים: עצירה, המשך, וחזרה 15 שניות אחורה. פספסת שורה? עצור, חזור אחורה, והמשך כאילו כלום.",
  },
  "native.s2_front_hint": "המצלמה הקדמית תיפתח, כמו בסלפי",
  "native.chip_on": "חלון הטקסט באוויר",
  "native.chip_off": "חלון הטקסט נסגר.",
  "native.chip_reopen": "להצגה מחדש",
  "native.e1_title": "החלון הצף לא נפתח הפעם",
  "native.e1_body": "זה קורה לפעמים, ובדרך כלל ניסיון נוסף פותר את זה.",
  "native.e1_retry": "לנסות שוב",
  "native.e2_title": "חזרת בלי סרטון, וזה לגמרי בסדר",
  "native.e2_body": {
    f: "חלון הטקסט עדיין כאן. כשתהיי מוכנה, פשוט נפתח את המצלמה שוב.",
    m: "חלון הטקסט עדיין כאן. כשתהיה מוכן, פשוט נפתח את המצלמה שוב.",
  },
  "native.e2_cta": "פתיחת המצלמה שוב",
  "native.tutorial_link": "תזכורת מלאה, איך זה עובד?",
...
export const BROADCAST_COPY_EN: Record<BroadcastCopyKey, string> = {
  ...
  // Native-capture guided wizard (r4, expert-panel respec)
  "native.intro_title": "Filming you, in three steps",
  "native.intro_step1": "Your script appears in a small window floating on screen",
  "native.intro_step2": "Your phone's regular camera opens, and the window stays on top",
  "native.intro_step3": "Tap the red button, press play on the text window, and talk",
  "native.intro_reassure": "Film as many times as you like. Nobody sees the attempts.",
  "native.intro_cta": "Got it, let's start",
  "native.step1_label": "Step 1 of 2",
  "native.step2_label": "Step 2 of 2",
  "native.s1_title": "First, let's get your script in the air",
  "native.s1_explain": "One tap moves your script into a small window that floats above everything. It waits there, frozen, until we reach the camera.",
  "native.s1_cta": "Show the script in the floating window",
  "native.s1_success": "The window is up",
  "native.s1_drag": "Drag it anywhere on screen. Pinch to make it bigger",
  "native.s2_title": "Almost filming. Three things inside:",
  "native.s2_item1": "Tap the camera's red button, like any selfie",
  "native.s2_item2": "Press play on the text window the moment you start talking",
  "native.s2_item3": "When you finish, stop and tap \"Use Video\". Everything comes back to us on its own",
  "native.s2_pacing_title": "How does the text move?",
  "native.s2_pacing_body":
    "At a steady, easy pace, like a TV-studio teleprompter. It won't wait for you, and you don't need to chase it. Tap the window for controls: pause, resume, and 15 seconds back. Missed a line? Pause, skip back, keep going.",
  "native.s2_front_hint": "The front camera opens, selfie style",
  "native.chip_on": "The text window is up",
  "native.chip_off": "The text window closed.",
  "native.chip_reopen": "Show it again",
  "native.e1_title": "The floating window didn't open this time",
  "native.e1_body": "It happens. A second try usually solves it.",
  "native.e1_retry": "Try again",
  "native.e2_title": "You came back without a video, and that's fine",
  "native.e2_body": "The text window is still here. When you're ready, we'll just open the camera again.",
  "native.e2_cta": "Open the camera again",
  "native.tutorial_link": "Full reminder, how does this work?",
