    ...
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ fontSize: 12, color: FG_M, lineHeight: 1.5 }}>
          תשלום מאובטח · Cardcom · SSL מוצפן
        </span>
      </div>
...
export default function ProductLandingPage({
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      attempts++;
      const w = window as Window & { Vimeo?: { Player: new (el: HTMLElement) => { setLoop(v: boolean): Promise<void> } } };
        ...
        <div className="hadar-box">
          <div className="hadar-photo-wrap" style={{ width: 110, height: 110, borderRadius: '50%', overflow: 'hidden', border: 'none', background: 'transparent', flexShrink: 0 }}>
            {whoPhotoSrc
              ...
              : <Image src="/hadarprotrait.jpg" alt="הדר דנן" width={220} height={220} style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
            }
          </div>
          <div style={{ flex: 1 }}>
