...
const PRINCIPLES: { icon: LucideIcon; title: string; body: string }[] = [
  {
    icon: Compass,
    title: "אסטרטגיה קודם",
    body: "לפני סרטון אחד - מבינים מי אתם, מה אתם מוכרים, ולמה הקהל שלכם צריך דווקא אתכם",
  },
  {
    icon: Flame,
    title: "תוכן שמגיע מבפנים",
    body: "לא תסריטים. לא טרנדים. תוכן שמגיע מהמקום האמיתי שלכם - וזה מה שגורם לו לעבוד",
  },
  {
    icon: TrendingUp,
    title: "מכירות שמגיעות מאליהן",
    body: "כשה־Signal נכון - הלקוחות הנכונים מזהים אתכם. אתם לא צריכים לשכנע, רק להיות נראים",
  },
];
