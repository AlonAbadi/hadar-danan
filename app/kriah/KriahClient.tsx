      ...
      <div style={{ width: "100%", maxWidth: 620, position: "relative", zIndex: 1 }}>
        ...
        {screen === "s7" && (
          <Card>
            ...
            <p style={{ fontSize: 16.5, lineHeight: 1.75, margin: "0 0 14px", color: C.fg, opacity: 0.92 }}>
              כל מה שיש לשוק להציע זה טיפול בתוכן: רעיונות להוקים, טכניקות צילום, נוסחאות לוויראליות. וזה לא מספיק, כי רעיונות קריאטיב לפי סוג העסק לא נוגעים במהות. הם לא מחוברים לבידול, כי הבידול עוד לא נוסח.
            </p>
            <p style={{ fontSize: 16.5, lineHeight: 1.75, margin: "0 0 14px", color: C.fg, opacity: 0.92 }}>
              אנחנו מתחילים מהבסיס שמשפיע על כל העסק: הדבר שרק אתם נותנים. <b style={{ color: C.gold }}>כשהוא מדויק, קל לדעת הכול מעבר: מה לצלם, מה לכתוב, ולמה שיבחרו דווקא בכם.</b> לזה אנחנו קוראים האות שלכם.
            </p>
