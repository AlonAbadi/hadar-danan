    ...
    >
      ...
      <nav
        ...
        style={{
          ...
          zIndex: 50,
          display: "flex",
          background: "rgba(44,40,30,0.72)",
          backdropFilter: "blur(36px) saturate(180%) brightness(1.15)",
          WebkitBackdropFilter: "blur(36px) saturate(180%) brightness(1.15)",
          borderTop: "1px solid rgba(255,255,255,0.14)",
          boxShadow: "inset 0 1px 0 rgba(255,255,255,0.12), 0 -6px 24px rgba(0,0,0,0.45)",
