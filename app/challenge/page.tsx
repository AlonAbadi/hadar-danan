...
const CHALLENGE_FAQS = [
  { question: "מתי מתחילים? צריך לחכות למחזור?", answer: "מתחילים מיד, תוך שניות אחרי התשלום. מפגש הפתיחה המוקלט פתוח לצפייה בו ברגע, וכל יום נפתח לפי הקצב שלכם. אין מחזורים ואין המתנה לקבוצה." },
  ...
  return (
    <>
      ...
      <ProductLandingPage
        ...
        solutionItems={[
          { num: "⚡", title: "גישה מיידית למפגש הפתיחה",     desc: "תוך שניות אחרי התשלום, מפגש הפתיחה המוקלט פתוח לצפייה: \"איך נראה שיווק בעידן מוצף בוידאו\". אין מחזורים. אין המתנה. מתחילים מתי שמתאים לכם." },
