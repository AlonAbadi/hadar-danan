...
const CHALLENGE_FAQS = [
  { question: "מה זה אתגר 7 הימים?", answer: "אתגר 7 הימים הוא תהליך קבוצתי בוואטסאפ שבו כל יום מקבלים סרטון מהדר + אתגר יומי לצלם ולהעלות לאינסטגרם. המטרה: לצאת לדרך עם סרטונים איכותיים שמקדמים מכירות ומטפחים קהילה סביב המותג האישי." },
  { question: "מה מקבלים כל יום?", answer: "בקבוצת הוואטסאפ: מפגש פתיחה, 7 סרטונים יומיים מהדר על סוג תוכן שמקדם מכירות, אתגר יומי לביצוע ולהעלאה לאינסטגרם, ומפגש סיום בזום: איך להפוך את הסרטונים לסיסטם מכירות." },
  ...
  { question: "מה ההבדל בין האתגר לסדנה?", answer: "האתגר הוא שבוע דיגיטלי בוואטסאפ של בניית הרגלי וידאו ואסטרטגיה. הסדנה (יום אחד פיזי) היא השלב הבא — עומק על ביטוי, נוכחות ומשפך שיווקי שלם." },
  { question: "מה אם יש לי שאלה תוך כדי האתגר?", answer: "הכל מתנהל בקבוצת הוואטסאפ — שאלות, תגובות ומשוב ישיר מהדר לאורך כל השבוע." },
];

export const metadata = {
  title: "אתגר 7 הימים | הדר דנן",
  description: "7 ימים, 7 סרטונים שמייצרים מכירות. תהליך קבוצתי בוואטסאפ עם הדרכה יומיומית מהדר דנן. 197 שקל בלבד.",
  ...
  return (
    <>
      <ProductSchema
        ...
        description="7 ימים, 7 סרטונים שמייצרים מכירות. תהליך קבוצתי בוואטסאפ עם הדרכה יומיומית מהדר דנן."
      ...
      <ProductLandingPage
        ...
        solutionTitle="במשך 7 ימים, כל משתתף מקבל בקבוצת הוואטסאפ:"
