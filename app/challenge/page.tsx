...
const CHALLENGE_FAQS = [
  ...
  { question: "מה מקבלים?", answer: "מפגש פתיחה זמין מיד עם הרכישה (on-demand — מתחילים היום, בלי להמתין למחזור), 7 סרטונים יומיים מהדר על סוג תוכן שמקדם מכירות, אתגר יומי לביצוע ולהעלאה לאינסטגרם, ומפגש סיום חי בזום: איך להפוך את הסרטונים לסיסטם מכירות. מפגש הסיום פתוח רק למי שסיים/ה את כל 7 הימים." },
  ...
  return (
    <>
      ...
      <ProductLandingPage
        ...
        solutionItems={[
          { num: "🧠", title: "מפגש פתיחה (on-demand)",      desc: "\"איך נראה שיווק בעידן מוצף בוידאו\" — נפתח מיד עם הרכישה. את/ה מתחיל/ה היום, בלי להמתין למחזור." },
