  ...
  return (
    <>
      ...
      <ProductLandingPage
        ...
        whoText="יצרתי את שיטת TrueSignal לאחר 4 שנים של עבודה עם 500+ עסקים. למדתי שהבעיה אינה מה לאמר - אלא מי אתה ולמה זה חשוב לאחרים. האתגר הוא השלב הראשון לגלות את זה."

        proofStats={[
          { val: "500+", label: "עסקים שצמחו" },
