...
const STRATEGY_FAQS = [
  ...
  { question: "מה ההבדל בין פגישת האסטרטגיה לאתגר 7 הימים?", answer: "האתגר מלמד שיטה לבד בקצב שלך. פגישת האסטרטגיה היא עבודה אישית ישירה עם הדר — 90 דקות שמרכזות את כל הניסיון שלה עם 500+ עסקים, מותאמות בדיוק לעסק שלך. כוללת ערבות תוצאה מלאה." },
  ...
  return (
    <>
      ...
      <ProductLandingPage
        ...
        headline={<>90 דקות עם הדר. <em>תוכנית שעובדת</em> עבורך.</>}
        ...
        whoText="פגישת האסטרטגיה היא הפורמט האינטנסיבי ביותר שלי - 90 דקות שמרכזות את כל הניסיון שלי עם 500+ עסקים, מותאמות בדיוק לעסק שלך. ערבות תוצאה מלאה - לא פיצחנו? פגישה נוספת עלינו."
