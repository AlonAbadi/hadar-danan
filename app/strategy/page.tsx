...
const STRATEGY_FAQS = [
  { question: "מה זו פגישת אסטרטגיה עם הדר דנן?", answer: "זו פגישה פרונטלית אחד-על-אחד, פנים אל פנים, שמטרתה בהירות מקסימלית. הדר מסתכלת על העסק שלך מבחוץ — כמה שעות של מיקוד, סינון, וחשיבה יצירתית בלייב. לא תבנית גנרית ולא שיעורי בית — תוכנית עבודה מדויקת שמבוססת על מה שה-עסק שלך צריך, לא מה שאתה חושב שאתה רוצה." },
  ...
  { question: "פגישה אחת מספיקה?", answer: "לחלק מהעסקים — כן. לחלק אחר — יש צורך בפגישה שנייה. הדר תגדיר את זה יחד איתך בסוף השיחה הראשונה. אם צריך עוד פגישה — היא ללא עלות נוספת." },
  ...
  { question: "איך מתקיימת הפגישה?", answer: "פגישה פרונטלית, פנים אל פנים, במשרד של הדר ברחוב החילזון 5 ברמת גן. 90 דקות. תיאום המועד תוך 24 שעות מהאישור." },
];
    ...
    <>
      ...
      <ProductLandingPage
        ...
        solutionItems={[
          ...
          { num: "5", title: "פגישה שנייה אם צריך — ללא עלות",    desc: "לחלק מהעסקים צריך פגישה שנייה להמשך. אם הדר תחליט שצריך — היא ללא עלות נוספת." },
        ]}
