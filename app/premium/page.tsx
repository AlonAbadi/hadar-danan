...
const PREMIUM_FAQS = [
  { question: "מה כולל יום צילום פרמיום?", answer: "יום צילום פרמיום כולל: אסטרטגיית תוכן מותאמת (לפני הצילום), יום צילום מלא עם צוות של שלושה אנשי מקצוע (צלם, במאי תוכן ומפיקה), 14 סרטונים ערוכים מוכנים לפרסום תוך שבועיים, ו-3 חודשי ליווי אחרי." },
...
export const metadata: Metadata = {
  ...
  description: "יום צילום מקצועי + אסטרטגיית תוכן = 14 סרטונים ערוכים שמייצרים לקוחות. שיטה שכבר עובדת ל-3,500+ עסקים.",
  ...
  return (
    <>
      <ProductSchema
        ...
        description="יום צילום מקצועי עם הצוות של BeeGood. יוצאים עם 14 סרטונים ערוכים ואסטרטגיית תוכן לשנה שלמה."
        url={`${APP_URL}/premium`}
        price={14000}
    ...
    <ViewContentTracker product="premium_14000" value={14000} />
      ...
      definitionBlock="יום צילום פרמיום הוא שירות הפקת תוכן וידאו מלא לעסקים. הצוות של BeeGood (צלם, במאי ומפיקה) מגיע אליך ליום שלם, מצלם 14 סרטונים קצרים מקצועיים על בסיס אסטרטגיית תוכן שנבנית מראש — ומספק אותם ערוכים עם כתוביות תוך שבועיים, כולל 3 חודשי ליווי."
      stats={[
