...
const PREMIUM_FAQS = [
  { question: "מה כולל יום צילום פרמיום?", answer: "יום צילום פרמיום כולל: אסטרטגיה עסקית ושיווקית מותאמת (לפני הצילום), יום צילום מלא עם צלם ובמאי תוכן — אצלך או אצלנו, 14 סרטונים ערוכים מוכנים לפרסום תוך שבועיים, ו-3 חודשי ליווי אחרי." },
...
export default async function PremiumPage() {
  ...
  return (
    ...
    <ViewContentTracker product="premium_14000" value={14000} />
      ...
      vimeoId="1184560999"
      headline={<>יום צילום אחד.<br/><em>תוכן שבאמת עובד.</em></>}
      heroSub="צלם ובמאי לצדך ליום שלם — אצלך או אצלנו. יוצאים עם 14 סרטונים ערוכים, מוכנים לפרסום, שמייצרים פניות ולקוחות."
      definitionBlock="יום צילום פרמיום הוא שירות הפקת תוכן וידאו מלא לעסקים. צלם ובמאי תוכן של BeeGood לצדך ליום שלם — אצלך או אצלנו. מצלמים 14 סרטונים קצרים מקצועיים על בסיס אסטרטגיה עסקית ושיווקית שנבנית מראש, ומספקים אותם ערוכים עם כתוביות תוך שבועיים, כולל 3 חודשי ליווי."
      stats={[
      ...
      solutionItems={[
        ...
        { num: "2", title: "יום צילום מלא עם צוות",   desc: "צלם מקצועי ובמאי תוכן לצדך ליום שלם — אצלך או אצלנו." },
