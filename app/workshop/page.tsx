...
const WORKSHOP_FAQS = [
  ...
  { question: "האם זה וירטואלי או פיזי?", answer: "זום — כדי לאפשר השתתפות מכל הארץ." },
];
  ...
  return (
    <>
      ...
      <ProductLandingPage
        ...
        vimeoId="1186650827"
        definitionBlock="סדנת יום אחד היא וורקשופ אינטנסיבי של 5 שעות מבוסס שיטת TrueSignal. 5 מודולים שבונים ביחד את מערכת השיווק של העסק — אסטרטגיית תוכן לשנה, מיתוג אישי, משפך מכירות אוטומטי ופרסום ממומן. 250+ עסקים כבר יישמו את השיטה עם 40% גידול ממוצע בהכנסה."
        stats={[
