...
const DEMO: KaveretData = {
  ...
  scriptsTotal: 7,
  scripts: [
    { number: 1, title: "משפט הזהות", hook: "אני קורא לאן העשייה שלך מובילה.", body: "לפני שאתה רואה את התמונה המלאה, יש שלוש נקודות שאני מתחיל מהן. הן קטנות. הן חשובות.", cta: "בוא נדבר." },
    { number: 2, title: "הוק עמוד ראשון",  hook: "הרעש הכי גדול מסתיר את האות הכי חשוב.", body: "כשהעולם רץ, השקט הפנימי הוא הכלי היחיד שנשאר לך.", cta: "" },
    { number: 4, title: "סיפור-תיק",       hook: "פעם היה מישהו שסיפר לי דבר אחד קטן.", body: "זה נראה כמו פרט זניח. שנה אחר כך, זה היה כל הסיפור.", cta: "" },
  ],
