...
type BulletRule = { q: number; a: Answer; text: string };

const BULLET_RULES: Record<string, BulletRule[]> = {
  free_training: [
...
function getPersonalizedReasons(answers: Answer[], productId: string): string[] {
