...
const HADAR_REELS: Video[] = [
  { id: "1188793607", title: "אין נאהב את המותג",               durationSec: 74,  portrait: true, isFree: true, thumb: "https://i.vimeocdn.com/video/2153151890-8e7a70d2ddab4ee1e253e06a69db11e3c8575e13cfb18ee1b2d6631e4f29815d-d_640x360?&r=pad&region=us" },
  { id: "1188790814", title: "תהליך מוכרת מיטות",              durationSec: 74,  portrait: true, isFree: true, thumb: "https://i.vimeocdn.com/video/2153148315-1a053bf671a4af54ec57a9a43271b6db0acdcae7066c0564da52f081c77544f0-d_640x360?&r=pad&region=us" },
...
const HADAR_LONG: Video[] = [
  { id: "1188789280", title: "תהליך אדיר",              durationSec: 394, portrait: true, isFree: true, thumb: "https://i.vimeocdn.com/video/2153146213-f1ac7afefba99927c3d8e3214c5f5b77835a3bf5c0433b6c4818e5a364133d55-d_640x360?&r=pad&region=us" },
...
const CLIENT_VIDEOS: Video[] = [
  { id: "1188794984", title: "חי סיני",                  durationSec: 57, portrait: true, isFree: true, thumb: "https://i.vimeocdn.com/video/2153153525-777573a5f129e2ecea1e05fbf334c1ccbe937d959ac0d72f3a5036ea076ca655-d_640x360?&r=pad&region=us" },
  { id: "1188794936", title: "שלי ליטאי",                durationSec: 53, portrait: true, isFree: true, thumb: "https://i.vimeocdn.com/video/2153153469-e3d1f9a5ba2e65cb2c4b116246fd505e0324e7844f77e3c4f4d46cce682a3373-d_640x360?&r=pad&region=us" },
  ...
  return (
    <div
      ...
      onClick={() => {
        ...
        onPlay({ id: video.id, portrait: video.portrait, title: video.title });
      }}
      ...
      <div style={{
        ...
        <img
          ...
          style={{
            ...
            filter: locked ? "blur(10px) brightness(0.5)" : undefined,
            transform: locked ? "scale(1.08)" : undefined,
          }}
        />
        {/* Gradient overlay */}
        {!locked && (
        ...
        {/* Title overlay (only when not locked) */}
        {!locked && (
          <p style={{
        ...
        {locked && (
          <div style={{
            ...
            <svg width={26} height={26} viewBox="0 0 24 24" fill="none" stroke="#E8B94A" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
...
export default function BingeClient({ isMember, isLoggedIn }: { isMember: boolean; isLoggedIn: boolean }) {
  ...
  return (
    ...
    >
        ...
        <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: "32px 20px 20px", background: "linear-gradient(to top, rgba(8,12,20,1) 0%, rgba(8,12,20,0.85) 60%, transparent 100%)" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <button style={{
              ...
              color: "#2a1d05", border: "none", borderRadius: 20,
      ...
      {/* ── Member upgrade banner (only for non-members) ────────────── */}
      {!isMember && (
        <a
          href={upgradeHref}
          style={{
      ...
      <div className="lg:px-5" style={{ display: "flex", flexDirection: "column", gap: 28, paddingBottom: 48 }}>
        {showHadar && (
          <>
            <ScrollRow title="קצת ממני אליכם"      videos={HADAR_REELS} onPlay={setPlaying} isMember={isMember} onLockedClick={handleLockedClick} />
            <ScrollRow title="תהליכים מלאים"    videos={HADAR_LONG}  onPlay={setPlaying} isMember={isMember} onLockedClick={handleLockedClick} />
          </>
        )}
        {showClients && (
          <ScrollRow title="הלקוחות שלנו"      videos={CLIENT_VIDEOS} onPlay={setPlaying} isMember={isMember} onLockedClick={handleLockedClick} />
        )}
